  ...
  return (
    <>
      ...
      <main className="container mx-auto px-10 text-justify leading-7 md:px-2">
        <section className="m-12 md:m-2">
          ...
          <div>
            <ul className="flex justify-around md:flex md:flex-col">
              <li className="flex w-96 px-3 flex-wrap md:w-full md:justify-center items-center md:mb-4">
        ...
        <section className="my-10">
          <h2 className="text-moradoSicetno text-4xl font-bold text-center mb-10">Conflictos a nivel Continente</h2>
          <div>
            <MapaAmerica />
          </div>
        </section>
