  ...
  <Layout>
    ...
    <main className="container mx-auto px-10 md:px-5 text-justify leading-7">
      ...
      <section className="mb-10">
        ...
        <p className="mb-6">
          <span className="font-bold">SICETNO</span>, 2022, es una plataforma digital editada por la <span className="font-bold">Universidad Nacional Autónoma de México</span>, Ciudad Universitaria, Alcaldía Coyoacán, C.P. 04510, Ciudad de México, a través del <span className="font-bold">Instituto de Investigaciones Sociales</span>, Circuito Mario de la Cueva s/n, Ciudad Universitaria, Col.Copilco, Alcaldía Coyoacán, C.P. 04510, Ciudad de México, Tel. 56227400 ext. 280, https://www.sicetno.org/, proyectosicetno@gmail.com, Responsable académica: <span className="font-bold">Natividad Gutiérrez Chong</span>. Certificado de Reserva de Derechos No. 04-2021-120813573100-203, otorgado por el Instituto Nacional del Derecho de Autor. Responsable de la última actualización, Instituto de Investigaciones Sociales, Circuito Mario de la Cueva s/n, Ciudad Universitaria, Col. Copilco, Alcaldía Coyoacán, C.P. 04510, Ciudad de México, fecha de la última modificación, 03 de marzo de 2022.
        </p>
        <p className="mb-6">
          El contenido disponible es responsabilidad de los autores y no refleja el punto de vista del Responsable académico o de la <span className="font-bold">UNAM</span>. Se autoriza la reproducción total o parcial de los textos aquí publicados siempre y cuando se cite la fuente completa y la dirección electrónica de la publicación.
        </p>
      </section>
    </main>
  </Layout>
