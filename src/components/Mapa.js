  ...
  return (
    <>
      <div className="flex justify-around mb-10">
        <button
          className="bg-naranjaSicetno text-white py-2 px-6 rounded-3xl shadow-lg transition duration-500 ease-in-out hover:bg-moradoSicetno transform hover:-translate-y-1 hover:scale-110"
      ...
      <div className="flex justify-around mb-6">
        <button
          className="bg-moradoSicetno text-white py-2 px-6 rounded-3xl shadow-lg transition duration-500 ease-in-out hover:bg-naranjaSicetno transform hover:-translate-y-1 hover:scale-110"
